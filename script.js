document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '054-497-4378';
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      alert('תודה ' + name + '! קיבלנו את פנייתך ונחזור אליך בהקדם.');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הדרך שלך משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '146c9578-71fb-4738-927f-d3dc4cbccfa5',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '146c9578-71fb-4738-927f-d3dc4cbccfa5';
